...
// Put your answer below -------------------------
  [B] because the variable letter is changed to z before x can ever be printed, and then changed again to y after the timeout is finished and printed one more time.
